    ...
    <div class="card rounded mb-5 mb-xl-8 shadow-lg">
        ...
        <div class="card-header rounded border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1">{{__('Governorate')}}</span>
            </h3>

            <div class="card-toolbar">
            <a href="{{route('governorate.create')}}" class="btn btn-sm btn-light-primary">
            ...
            <!--end::Svg Icon-->{{__('Add')}}{{__('Governorate')}}+</a>
        </div>
                ...
                <table class="table table-hover align-middle gs-0 gy-4">
                    ...
                    <thead>
                        <tr class="text-center border-3 fw-bolder text-muted bg-light">
                            <th class="ps-2 min-w-125px rounded-start">{{__('Governorate')}}</th>
                            <th class="ps-2 min-w-125px rounded-start">{{__('image')}}</th>
                        ...
                        @foreach ($govs as $c)
                            <tr class="text-center border-3 m-auto">
                                 ...
                                 <td class="px-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex flex-column">
                                            <a href="#"
                                                class="text-dark fw-bolder text-hover-primary mb-1 fs-6">{{ $c->name_en }}</a>
                                ...
                                <td class="px-3">
                                 ...
                                 <a href="{{ route('governorate.edit', $c->id) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                ...
                                <!--end::Svg Icon-->
                                    ...
                                    <form action="{{ route('governorate.destroy', $c->id) }}" method="post" id='delform'
