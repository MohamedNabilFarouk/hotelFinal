...
{{--                                        <a href="#" class="menu-link px-3">{{__(Booking Report)}}</a>--}}
{{--                                    </div>--}}
{{--                                    <!--end::Menu item-->--}}
{{--                                </div>--}}
{{--                                <!--end::Menu 3-->--}}
                            ...
                            <div class="card-p mt-n20 position-relative">
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
                                        ...
                                        <!--end::Svg Icon-->
                                        <a href="" class="text-warning fw-bold fs-6">{{__('Net Balance')}}   {{$net_balance}} EGP</a> <br />
                                        <a href="" class="text-warning fw-bold fs-6">{{__('Total Balance')}}   {{$total_balance}} EGP </a>
                                    </div>
                                    <!--end::Col-->
                                    <!--begin::Col-->
                                    <div class="col bg-light-primary px-6 py-8 rounded-2 mb-7">
                                        ...
                                        <!--end::Svg Icon-->
                                        <a href="#" class="text-primary fw-bold fs-6">{{__('Total Booking')}}  :   {{$total_booking}}</a> <br />
                                    ...
                                    <div class="card-p mt-n20 position-relative">
                                        ...
                                        <div class="row g-0">
                                            ...
                                            <div class="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
                                                ...
                                                <!--end::Svg Icon-->
                                                <a href="" class="text-warning fw-bold fs-6">{{__('Total')}}   {{$admin_bookedTotal_month}} EGP</a> <br />
                                                <a href="" class="text-danger fw-bold fs-6">{{__('Earning')}}   {{$admin_site_balance}} EGP </a>
                                            </div>
                                            <!--end::Col-->
                                            <!--begin::Col-->
                                            <div class="col bg-light-primary px-6 py-8 rounded-2 mb-7">
                                                ...
                                                <!--end::Svg Icon-->
                                                <a href="#" class="text-primary fw-bold fs-6">{{__('Total Booking')}}  :   {{$admin_bookedCount_month}}</a> <br />
                                                {{-- <a href="#" class="text-primary fw-bold fs-6">@lang('site.Count'): 10</a> --}}
                                            </div>
                                            <!--end::Col-->
                                        </div>
                                        <!--end::Row-->
                                         ...
                                         <div class="row g-0">
                                            ...
                                            <div class="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
                                                ...
                                                <!--end::Svg Icon-->
                                                <a href="" class="text-warning fw-bold fs-6">{{__('Vendors')}}  :  {{$vendors}} </a> <br />
                                            ...
                                            <div class="col bg-light-primary px-6 py-8 rounded-2 mb-7">
                                                ...
                                                <!--end::Svg Icon-->
                                                <a href="" class="text-primary fw-bold fs-6">{{__('Rooms Available Now')}}  : {{$admin_availableRooms}}  </a><br />
                                                {{-- <a href="#" class="text-primary fw-bold fs-6">@lang('site.Count'): 10</a> --}}
                                            </div>
                                            <!--end::Col-->
                                        </div>
        ...
        @if(auth()->user()->roles[0]->name == 'vendor')
                ...
                <div class='col-md-12'>
                <h3 class="card-title fw-bolder text-Black">{{__('Bank Transfer Report')}}</h3>
                <div class="card-body py-3">
                    ...
                    <div class="table-responsive rounded">
                        ...
                        @foreach($VendorTransactions as $index => $c)
                            <tr class="text-center border-3 m-auto">
                                <td class="px-3">
                                    <div class="d-flex align-items-center">
                                            <span class="text-muted fw-bold text-muted d-block fs-7">{{$c->withdrawal_date}}</span>
                                        </div>
                                    </div>
                                </td>

                                <td class="px-3">
                                            <span class="badge badge-light-primary fs-7 fw-bold">{{$c->withdrawal_amount}}</span>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
