...
@section('content')
    ...
    <div class="container-fluid page__container p-2">
        ...
        <div class="card rounded card-form__body card-body shadow-lg">
            <form class="form-control" method="post" action="{{ route('banner.update', $banner->id) }}"
                ...
                <div class="form-group mb-10">
                    <label for="exampleFormControlInput1" class="required form-label">@lang('site.Title') @lang('site.in
                        Arabic') </label>
                    <input type='text' name="title_ar" class="form-control" value="{{ $banner->title_ar }}" />
                </div>

                <div class="form-group mb-10">
                    <label for="exampleFormControlInput1" class="required form-label">@lang('site.Description')
                        @lang('site.in English') </label>
                    <textarea name="des_en" class="form-control">{{ $banner->des_en }}</textarea>
                </div>

                <div class="form-group mb-10">
                    <label for="exampleFormControlInput1" class="required form-label">@lang('site.Description')
                        @lang('site.in Arabic') </label>
                    <textarea name="des_ar" class="form-control">{{ $banner->des_ar }}</textarea>
                ...
                <div class="form-group mb-10">
                    ...
                    <input type='date' name="expire_at" class="form-control" value="{{ old('expire_at') }}" />
                </div>
                ...
                <div class="form-group col-sm-12 card card-primary card-outline">
                    <div class="text-center col-sm-12">
                        <h3 class="m-3">@lang('site.default')</h3>
                    </div>
                ...
                <!-- <div class="form-group mb-10">
                    <label for="exampleFormControlInput1" class="required form-label">@lang('site.default') </label>
                    <input type='file' name="default" class="form-control" value="{{ $banner->default }}" />
                    @error('default')
                                <br />
                                <span class="text-danger mx-1">{{ $message }}</span>
                            @enderror
