    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div class="d-flex align-items-center me-3">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">@lang('site.dashboard')
                    <!--begin::Separator-->
        ...
        <div id="kt_content_container" class="container">
            ...
            <div class="row gy-5 g-xl-8">
                ...
                <div class="col-xxl-4">
                    ...
                    <div class="card rounded card-xxl-stretch">
                        <!--begin::Header-->
                        <div class="card-header rounded border-0 bg-danger py-5">
                            ...
                            <div class="card-p mt-n20 position-relative">
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
                                        ...
                                        <!--end::Svg Icon-->
                                        <a href="{{ route('order.ByStatus', 'Delivered') }}"
                                            class="text-warning fw-bold fs-6">@lang('site.monthly Sales')
                                            Count:{{ $monthly_sales->count() }}</a> <br />
                                        <a href="{{ route('order.ByStatus', 'Delivered') }}"
                                            class="text-warning fw-bold fs-6">@lang('site.Total'):
                                            {{ $monthly_sales->sum('total') }} &pound;</a>
                                    </div>
                                    <!--end::Col-->
                                    <!--begin::Col-->
                                    {{--  <div class="col bg-light-primary px-6 py-8 rounded-2 mb-7">
                                        ...
                                        <a href="#" class="text-primary fw-bold fs-6">@lang('site.New Users')</a> <br />
                                         <a href="#" class="text-primary fw-bold fs-6">@lang('site.Count'):
                                            {{ $new_user->count() }}</a> 
                                    </div>--}}
                                    <!--end::Col-->
                                </div>
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col bg-light-danger px-6 py-8 rounded-2 me-7">
                                        ...
                                        <!--end::Svg Icon-->
                                        <a href="{{ route('order.ByStatus', 'Pending') }}"
                                            class="text-danger fw-bold fs-6 mt-2">@lang('site.Pending Orders')</a>
                                        <a href="{{ route('order.ByStatus', 'Pending') }}"
                                            class="text-danger fw-bold fs-6 mt-2">@lang('site.Count'):
                                            {{ $pending_orders->count() }}</a> <br />
                                    ...
                                    <div class="col bg-light-success px-6 py-8 rounded-2">
                                        ...
                                        <!--end::Svg Icon-->
                                        <a href="{{ route('order.ByStatus', 'Confirmed') }}"
                                            class="text-success fw-bold fs-6 mt-2">@lang('site.Delivered Orders')</a>
                                        <a href="{{ route('order.ByStatus', 'Confirmed') }}"
                                            class="text-success fw-bold fs-6 mt-2">@lang('site.Count'):
                                            {{ $deliverd_orders->count() }}</a> <br />
                ...
                <div class="col-xxl-4">
                    ...
                    {{-- <div class="card rounded card-xxl-stretch">
                        <!--begin::Header-->
                        <div class="card-header rounded align-items-center border-0 mt-4">
                ...
                {{-- <div class="col-xxl-4">
                    ...
                    <div class="card rounded card-xxl-stretch-50 mb-5 mb-xl-8">
                        <!--begin::Body-->
            ...
            {{-- <div class="row gy-5 gx-xl-8">
                ...
                <div class="col-xxl-4">
                    <!--begin::List Widget 3-->
                    <div class="card rounded card-xxl-stretch mb-xl-3">
                        <!--begin::Header-->
                        ...
                        <div class="card-body py-3">
                            ...
                            <div class="table-responsive rounded">
                                ...
                                <table class="table table-hover table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                    <!--begin::Table head-->
                                    <thead>
                                        <tr class="text-center border-3 fw-bolder text-muted">
                                            <th class="w-25px">
           ...
           {{-- <div class="row gy-5 g-xl-8">
            ...
            <div class="row g-5 gx-xxl-8">
                ...
                {{-- <div class="col-xxl-4">
                    ...
                    <div class="card rounded card-xxl-stretch mb-xl-3">
                        <!--begin::Beader-->
                        <div class="card-header rounded border-0 py-5">
                            <h3 class="card-title align-items-start flex-column">
                ...
                <div class="col-xxl-8">
                    ...
                    <div class="card rounded card-xxl-stretch mb-5 mb-xxl-8">
                        <!--begin::Header-->
                        <div class="card-header rounded border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder fs-3 mb-1">@lang("site.Latest Orders")</span>
                                <!-- <span class="text-muted mt-1 fw-bold fs-7">@lang('site.More than')
                                    
                                    @lang('site.new product')</span> -->
                            </h3>
                            <div class="card-toolbar">
                                <ul class="nav">
                                    <li class="nav-item">
                                        <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light-primary active fw-bolder px-4 me-1"
                                            data-bs-toggle="tab" href="#kt_table_widget_5_tab_1">@lang('site.Month')</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light-primary fw-bolder px-4 me-1"
                                            data-bs-toggle="tab" href="#kt_table_widget_5_tab_2">@lang('site.Week')</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light-primary fw-bolder px-4"
                                            data-bs-toggle="tab" href="#kt_table_widget_5_tab_3">@lang('site.Day')</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <tr class="text-center border-3 fw-bolder text-muted bg-light">
                        ...
                        <th class="min-w-200px text-start rounded-end">@lang('site.actions')</th>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($latest_orders_month as $index => $c)
                                                    <tr class="text-center border-3 m-auto">
                                                         <td class="px-3">
                                                    ...
                                                    <select class="form-control"  name='status' id='sel_status{{$index}}'>
                                                        ...
                                                        <option value='On Delivery' @if($c->status == 'On Delivery') selected @endif readonly>@lang('site.On Delivery')</option>
                                                        <option value='Delivered' @if($c->status == 'Delivered') selected @endif readonly>@lang('site.Delivered')</option>

                                                    </select>
                                                    <!-- <span class="text-dark fw-bolder text-hover-primary mb-1 fs-6">{{$c->status}}</span> -->
                        ...
                        <td class="text-start">
                            ...
                            <a href="{{ route('order.details', $c->id) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                            <i class="fa fa-eye"></i>
                            </a>
                    ...
                    <tr class="text-center border-3 fw-bolder text-muted bg-light">
                        ...
                        <th class="min-w-200px text-start rounded-end">@lang('site.actions')</th>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($latest_orders_week as $index => $c)
                                                    <tr class="text-center border-3 m-auto">
                                                         <td class="px-3">
                                                         <span class="text-dark fw-bolder text-hover-primary mb-1 fs-6">{{$c->id}}</span>
                                                        </td>
                                                        ...
                                                        <span class="text-dark fw-bolder text-hover-primary mb-1 fs-6">{{$c->user->name ?? ''}}</span>
                                                            ...
                                                            <span class="text-dark fw-bolder text-hover-primary mb-1 fs-6">{{$c->total}} LE</span>
                                                                                        ...
                                                                                        <form action="{{ route('order.update', $c->id) }}" method='post' id='status_form_week{{$index}}'>
                                                    <input type='hidden' id='order_id' value='{{$c->id}}' name='id'>
                                                    @csrf
                                                    @method('put')
                                                    <td class="px-3">
                                                    <!-- <span class="badge badge-light-primary fs-7 fw-bold">{{$c->status}}</span> -->
                                                    <select class="form-control"  name='status' id='sel_status_week{{$index}}'>
                                                    ...
                                                    <!-- <span class="text-dark fw-bolder text-hover-primary mb-1 fs-6">{{$c->status}}</span> -->
                                                        ...
                                                        <script>
                                                            $(document).ready(function(){
                                                                $('#sel_status_week{{$index}}').change(function(){
                                                                    // var id = $('#order_id').val();

                                                                    $("#status_form_week{{$index}}").submit();
                                                                });
                                                            });
                                                        </script>


                            <form action="{{ route('order.assign', $c->id) }}" method='post' id='delivery_form_week{{$index}}'>
                                    <input type='hidden' id='order_id' value='{{$c->id}}' name='id'>
                                    @csrf
                                    @method('put')
                                    <td class="px-3">
                                        ...
                                        @if($c->status == 'Pending')
                                            ...
                                            <select class="form-control"  name='delivery_id' id='sel_delivery_week{{$index}}'>
                                                    <option value="">@lang('site.Assign Order To Delivery Boy')</option>
                                                    @foreach($delivery as $d)
                                                        <option value='{{$d->id}}' {{ $d -> id = $c -> delivery_id ? 'selected' : '' }}>{{ $d -> user -> name ?? '' }}</option>
                                                    @endforeach
                                        ...
                                        <script>
                                                    $(document).ready(function(){
                                                        $('#sel_delivery_week{{$index}}').change(function(){
                                                            // var id = $('#order_id').val();

                                                            $("#delivery_form_week{{$index}}").submit();
                                                    });
                                                });
                                        </script>
                    ...
                    <tr class="text-center border-3 fw-bolder text-muted bg-light">
                        ...
                        <th class="min-w-200px text-start rounded-end">@lang('site.actions')</th>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($latest_orders_day as $index => $c)
                                                    <tr class="text-center border-3 m-auto">
                                                         <td class="px-3">
                                                         <span class="text-dark fw-bolder text-hover-primary mb-1 fs-6">{{$c->id}}</span>
                                                        </td>
                                                    ...
                                                    <td class="px-3">
                                                    <!-- <span class="badge badge-light-primary fs-7 fw-bold">{{$c->status}}</span> -->
                                                    <select class="form-control"  name='status' id='sel_status_day{{$index}}'>
                                                    ...
                                                    <!-- <span class="text-dark fw-bolder text-hover-primary mb-1 fs-6">{{$c->status}}</span> -->
                                                        ...
                                                        <script>
                                                            $(document).ready(function(){
                                                                $('#sel_status_day{{$index}}').change(function(){
                                                                    // var id = $('#order_id').val();

                                                                    $("#status_form_day{{$index}}").submit();
                                                                });
                                                            });
                                                        </script>


                            <form action="{{ route('order.assign', $c->id) }}" method='post' id='delivery_form_day{{$index}}'>
                                    <input type='hidden' id='order_id' value='{{$c->id}}' name='id'>
                                    @csrf
                                    @method('put')
                                    <td class="px-3">
                                        ...
                                        @if($c->status == 'Pending')
                                            ...
                                            <select class="form-control"  name='delivery_id' id='sel_delivery_day{{$index}}'>
                                                    <option value="">@lang('site.Assign Order To Delivery Boy')</option>
                                                    @foreach($delivery as $d)
                                                        <option value='{{$d->id}}' {{ $d -> id = $c -> delivery_id ? 'selected' : '' }}>{{ $d -> user -> name ?? '' }}</option>
                                                    @endforeach
                                        ...
                                        <script>
                                                    $(document).ready(function(){
                                                        $('#sel_delivery_day{{$index}}').change(function(){
                                                            // var id = $('#order_id').val();

                                                            $("#delivery_form_day{{$index}}").submit();
                                                    });
                                                });
                                        </script>
