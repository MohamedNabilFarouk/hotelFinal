...
<div class="toolbar" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div class="d-flex align-items-center me-3">
            <!--begin::Title-->
            <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">{{__('Spaces')}}
            <!--begin::Separator-->
...
<div class="card rounded mb-5 mb-xl-8 shadow-lg">
    ...
    <div class="card-header rounded border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bolder fs-3 mb-1">{{__('Spaces')}}</span>
        </h3>
        <div class="card-toolbar">
            <a href="{{route('space.create')}}" class="btn btn-sm btn-light-primary">
            ...
            <table class="table table-hover align-middle gs-0 gy-4">
                ...
                <thead>
                    <tr class="text-center border-3 fw-bolder text-muted bg-light">
                        <th class="ps-4 min-w-325px rounded-start">{{__('Space')}}</th>
                        ...
                        <th class="min-w-100px">{{__('Bathrooms')}}</th>
                        <th class="min-w-100px">{{__('Max Guest')}}</th>
                        <th class="min-w-100px">{{__('Size')}}</th>
                        <th class="min-w-100px">{{__('Price')}}</th>
                        <th class="min-w-100px">{{__('Sala Price')}}</th>
                        <th class="min-w-100px">{{__('Star Rate')}}</th>
                        <th class="min-w-100px">{{__('On Sale')}}</th>
                        <th class="min-w-200px">{{__('Status')}}</th>
                ...
                @foreach($spaces as $p)
                    ...
                    <tr class="text-center border-3 m-auto align-middle">
                        <td class="px-3">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column">
                                    <a href="{{ route('space.edit', $p->id) }}" class="text-dark fw-bolder text-hover-primary mb-1 fs-6">{{$p->title}}</a>
                        ...
                        <td class="px-3">
                         ...
                         <td class="px-3">
                            <a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{$p->type->title  ?? ''}}</a>
                        </td>
                         <td class="px-3">
                         ...
                         <td class="px-3">
                            <a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{$p->bathroom}}</a>
                        </td>
                         <td class="px-3">
                            <a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{$p->max_guest}}</a>
                        </td>
                         <td class="px-3">
                         ...
                         <td class="px-3">
                            <a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{$p->sale_price}}</a>
                        </td>

                         <td class="px-3">
                            <a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{$p->on_sale}}</a>
                        </td>
                         <td class="px-3">
                         ...
                         <td class="border text-center">
                            ...
                            <a href="{{ route('space.edit', $p->id) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                            ...
                            <form action="{{ route('space.destroy', $p->id) }}" method="post" id='delform' style="display: inline-block">
                                @csrf
                                @method('delete')
