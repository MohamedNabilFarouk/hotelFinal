    ...
    <div class="card rounded mb-5 mb-xl-8 shadow-lg">
        ...
        <div class="card-header rounded border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1">{{__('Currency')}}</span>
            </h3>
            ...
            <!--end::Svg Icon-->{{__('Add')}}{{__('Currency')}}+</a>
        </div>
                ...
                <table class="table table-hover align-middle gs-0 gy-4">
                    ...
                    <thead>
                        <tr class="text-center border-3 fw-bolder text-muted bg-light">
                            <th class="ps-2 min-w-125px rounded-start">{{__('Currency')}}</th>
                            <th class="ps-2 min-w-125px rounded-start">{{__('Exchange Rate')}}</th>
                        ...
                        @foreach ($currencies as $c)
                            <tr class="text-center border-3 m-auto">
                                        ...
                                        <div class="d-flex flex-column">
                                            <a href="#"
                                                class="text-dark fw-bolder text-hover-primary mb-1 fs-6">{{ $c->name }}</a>
                                                 ...
                                                 <span class="text-muted fw-bold text-muted d-block fs-7">{{$c->abbr}}</span>
                                        </div>
                                 ...
                                 <td class="px-3">
                                    <div class="d-flex flex-column">
                                        <a href="#"
                                            class="text-dark fw-bolder text-hover-primary mb-1 fs-6">{{ $c->ex_rate }}</a>
                                    </div>
                                </td>
                                ...
                                <!--end::Svg Icon-->
                                    ...
                                    <form action="{{ route('currency.destroy', $c->id) }}" method="post" id='delform'
