<template>
    <div>
        <ul class="nav nav-bottom fixed-bottom shadow bg-light d-flex d-md-none">
            <li class="nav-item border w-20 text-center">
                <router-link to="/" class="nav-link text-capitalize">
                    <i class="fa fa-home d-block"></i>
                        {{ $t('home') }}
                </router-link>
            </li>
            <li class="nav-item border w-20 text-center">
                <router-link to="/hotels" class="nav-link text-capitalize">
                    <i class="fa fa-building-o d-block"></i>
                        {{ $t('hotels') }}
                </router-link>
            </li>
            <li class="nav-item border w-20 text-center">
                <router-link to="/tours" class="nav-link text-capitalize">
                    <i class="fa fa-pagelines d-block"></i>
                        {{ $t('tours') }}
                </router-link>
            </li>
            <li class="nav-item border w-20 text-center">
                <router-link to="/tours/special" class="nav-link text-capitalize">
                    <i class="fa fa-pagelines d-block"></i>
                    <small>{{ $t('special tours') }}</small>
                </router-link>
            </li>
            <li class="nav-item border w-20 text-center">
                <a href="#" @click.prevent="showModal()" class="nav-link text-capitalize">
            ...
            <!-- search modal   -->
            <modal :scrollable="true" width="90%" height="auto" name="searchModal">
