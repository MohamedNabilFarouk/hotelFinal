<template>
    <div>
        <!-- Main Container  -->
        <Breadcrumbs PageTitle="Special Tours" PageLink="/tours/special" backgroundImage="https://demo.wpthemego.com/html/sw_portkey/image/breadcrumbs.jpg" />
            ...
            <div class="row">
                <aside class="col-md-3 col-sm-4 col-xs-12 content-aside left_column sidebar-offcanvas">
                    ...
                    <div class="module-rate clearfix">
                        <h3 style="font-size: 1.75rem;" class="modtitle">Special Tours searching</h3>
...
export default {
    ...
    mounted() {
        ...
        this.searchToursForm.type = 'special';
        this.filterToursForm.type = 'special';
    ...
    methods: {
        ...
        getTours(page = 1){
            axios.get('tours/special?page=' + page).then((res)=>{
